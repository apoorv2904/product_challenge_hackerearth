...
def inception_v4_model(img_rows, img_cols, color_type=1, num_classeses=None, dropout_keep_prob=0.2):
    ...
    if K.image_dim_ordering() == 'th':
      ...
      weights_path = 'finetune_models/imagenet_models/inception-v4_weights_th_dim_ordering_th_kernels.h5'
    else:
      # Use pre-trained weights for Tensorflow backend
      weights_path = 'finetune_models/imagenet_models/inception-v4_weights_tf_dim_ordering_tf_kernels.h5'
